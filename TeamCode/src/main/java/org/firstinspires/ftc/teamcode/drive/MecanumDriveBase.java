...
public class MecanumDriveBase extends MecanumDrive {
    ...
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(40, 0, 0.25);

    public static double LATERAL_MULTIPLIER = 1.3;//1.5;
    ...
    public MecanumDriveBase(HardwareMap hardwareMap) {
       ...
       // imu = hardwareMap.get(IMU.class, "imu");
        ...
        rightRear.setDirection(DcMotor.Direction.FORWARD); // manual feed fwd working
    ...
    public Double getExternalHeadingVelocity() {
        ...
        return (double) 0.0; //55.0;
        //float xRotationRate = angularVelocity.xRotationRate;
